...
function void
jump_to_location(App *app, View_ID view, String_Const_u8 location){
...
static Parsed_Jump
seek_next_jump_in_view(App *app, Arena *arena, View_ID view, i32 skip_sub_errors, Scan_Direction direction, i64 *line_out){
...
static b32
seek_jump_(App *app, b32 skip_repeats, b32 skip_sub_errors, i32 direction){
    b32 result = false;
