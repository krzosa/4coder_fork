...
{ PROC_LINKS(jump_to_hiperlink_at_cursor, 0), true, "jump_to_hiperlink_at_cursor", 27, "Jump to the first definition in the code index matching an identifier at the cursor", 83, "./4coder_code_index_listers.cpp", 31, 160 },
{ PROC_LINKS(jump_to_hiperlink_at_cursor_other_panel, 0), true, "jump_to_hiperlink_at_cursor_other_panel", 39, "Jump to the first definition in the code index matching an identifier at the cursor", 83, "./4coder_code_index_listers.cpp", 31, 148 },
