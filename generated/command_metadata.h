...
{ PROC_LINKS(goto_first_jump, 0), false, "goto_first_jump", 15, "If a buffer containing jump locations has been locked in, goes to the first jump in the buffer.", 95, "./4coder_jump_sticky.cpp", 24, 622 },
{ PROC_LINKS(goto_first_jump_same_panel_sticky, 0), false, "goto_first_jump_same_panel_sticky", 33, "If a buffer containing jump locations has been locked in, goes to the first jump in the buffer and views the buffer in the panel where the jump list was.", 153, "./4coder_jump_sticky.cpp", 24, 639 },
...
{ PROC_LINKS(goto_next_jump, 0), false, "goto_next_jump", 14, "If a buffer containing jump locations has been locked in, goes to the next jump in the buffer, skipping sub jump locations.", 123, "./4coder_jump_sticky.cpp", 24, 561 },
{ PROC_LINKS(goto_next_jump_no_skips, 0), false, "goto_next_jump_no_skips", 23, "If a buffer containing jump locations has been locked in, goes to the next jump in the buffer, and does not skip sub jump locations.", 132, "./4coder_jump_sticky.cpp", 24, 591 },
{ PROC_LINKS(goto_prev_jump, 0), false, "goto_prev_jump", 14, "If a buffer containing jump locations has been locked in, goes to the previous jump in the buffer, skipping sub jump locations.", 127, "./4coder_jump_sticky.cpp", 24, 578 },
{ PROC_LINKS(goto_prev_jump_no_skips, 0), false, "goto_prev_jump_no_skips", 23, "If a buffer containing jump locations has been locked in, goes to the previous jump in the buffer, and does not skip sub jump locations.", 136, "./4coder_jump_sticky.cpp", 24, 608 },
...
{ PROC_LINKS(jump_to_hiperlink_at_cursor, 0), true, "jump_to_hiperlink_at_cursor", 27, "Jump to the first definition in the code index matching an identifier at the cursor", 83, "./4coder_jump_sticky.cpp", 24, 485 },
{ PROC_LINKS(jump_to_hiperlink_at_cursor_other_panel, 0), true, "jump_to_hiperlink_at_cursor_other_panel", 39, "Jump to the first definition in the code index matching an identifier at the cursor", 83, "./4coder_jump_sticky.cpp", 24, 473 },
