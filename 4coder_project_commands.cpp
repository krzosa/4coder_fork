    ...
    if (needs_to_do_work){
        ...
        if (do_bat_script){
            if (!status.bat_exists){
                String8 default_flags_bat = debug_config_default_flags_bat;
                String8 default_compiler_bat = debug_config_default_compiler_bat;
        ...
        if (do_sh_script){
            if (!status.bat_exists){
                String8 default_flags_sh = debug_config_default_flags_sh;
                String8 default_compiler_sh = debug_config_default_compiler_sh;
